...
## `eventReactive()` : App [`"materials/35-app"`](https://github.com/mcanouil/rshiny/tree/master/materials/35-app/app.R) {.smaller}
...
## `eventReactive()` : App [`"materials/35-app"`](https://github.com/mcanouil/rshiny/tree/master/materials/35-app/app.R)
...
## Mise en pratique : Essai 4 {.smaller}

```{r, code = readLines("materials/52-app/app.R", encoding = "UTF-8")[c(1:3, 42:67)]}
```

<div class="notes">App [`"materials/51-app"`](https://github.com/mcanouil/rshiny/tree/master/materials/51-app/app.R)</div>


## Mise en pratique : Essai 4
...
* `flexdashboard::flex_dashboard`  
    \(\Rightarrow\) App [`"materials/55-app"`](https://github.com/mcanouil/rshiny/tree/master/materials/55-app/app.R)
