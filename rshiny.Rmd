...
1. Créer un fomulaire : Nom, sexe, loisirs (avec les types adéquats).


<div class="notes">
1. App [`"materials/02-app"`](https://github.com/mcanouil/rshiny/tree/master/materials/a-exapp/app.R)
</div>
