...
<div class="notes">App `"materials/34-app"`</div>
...
<div class="notes">App `"materials/35-app"`</div>
...
## Affichage conditionnel des éléments `ui` {.smaller}

```{r, code = readLines("materials/37-app/app.R", encoding = "UTF-8")[c(3:8, 10:29)]}
```

<div class="notes">
App `"materials/37-app"`
...
<div class="notes">App `"materials/39-app"`</div>
...
<div class="notes">App `"materials/40-app"`</div>


## Nombre d'éléments `ui` indéfini

```{r, echo = FALSE, eval = TRUE, out.extra = 'class="shadow" style="margin: auto;"', out.width = "30%", fig.align = "center", fig.show = "hold"}
for (iapp in c(41:43)) {
...
<div class="notes">
App `"materials/41-app"`
App `"materials/42-app"`
App `"materials/43-app"`
</div>
...
code_ellipsis <- c(
  readLines("materials/41-app/app.R", encoding = "UTF-8")[c(1:9)],
  "...",
  readLines("materials/41-app/app.R", encoding = "UTF-8")[c(30:46)]
)
```
...
<div class="notes">App `"materials/41-app"`</div>
...
<div class="notes">App `"materials/42-app"`</div>
...
<div class="notes">App `"materials/43-app"`</div>


## Nombre d'éléments `ui` indéfini

```{r, code = readLines("materials/43-app/app.R", encoding = "UTF-8")[c(30:39)]}
```
...
```{r, code = readLines("materials/43-app/app.R", encoding = "UTF-8")[c(1:4, 41:53)]}
```
