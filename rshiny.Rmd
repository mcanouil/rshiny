...
<div class="notes">
App [`"materials/01-app"`](https://github.com/mcanouil/rshiny/tree/master/materials/01-app/app.R)
* URL par défaut (hôte)
...
* Essayer les différents `input` en jouant sur les arguments.

* Créer un fomulaire : nom, prénom, age, sexe, loisirs (choix multiples).

<div class="notes">App [`"materials/99-ex01"`](https://github.com/mcanouil/rshiny/tree/master/materials/99-ex01/app.R)</div>
...
```{r, code = readLines("materials/99-ex01/app.R", encoding = "UTF-8")[3:14]}
```
...
```{r, code = readLines("materials/11-app/app.R", encoding = "UTF-8")[c(3:15)]}
```
...
* Ajouter une phrase de bienvenue aléatoire depuis le `server`.

* Créer une application affichant un graphique et son code.


<div class="notes">
* App [`"materials/99-ex01"`](https://github.com/mcanouil/rshiny/tree/master/materials/99-ex01/app.R)
* App [`"materials/99-ex02"`](https://github.com/mcanouil/rshiny/tree/master/materials/99-ex02/app.R)
* App [`"materials/99-ex03"`](https://github.com/mcanouil/rshiny/tree/master/materials/99-ex03/app.R)
</div>
...
```{r, code = readLines("materials/99-ex02/app.R", encoding = "UTF-8")[3:17]}
```

<div class="notes">App [`"materials/99-ex02"`](https://github.com/mcanouil/rshiny/tree/master/materials/99-ex02/app.R)</div>
...
```{r, code = readLines("materials/99-ex02/app.R", encoding = "UTF-8")[19:29]}
```
...
```{r, code = readLines("materials/99-ex03/app.R", encoding = "UTF-8")[3:17]}
```

<div class="notes">App [`"materials/99-ex03"`](https://github.com/mcanouil/rshiny/tree/master/materials/99-ex03/app.R)</div>
...
* Essayer la structure grille avec `fluidPage()`, `fluidRow()`, `fixedRow()` et `column()`.

* Reproduire les interfaces suivantes.

<div class="centered">
```{r, echo = FALSE, eval = TRUE, out.width = "49%", out.extra = 'class="shadow" style="display: inline;"'}
for (iapp in c("99-ex04", "99-ex05")) {
app_name <- iapp 
appshot(
  app = paste0("materials/", app_name, "/app.R"), 
  delay = 2,
  vwidth = 7.5 * params$dpi,
  vheight = 4 * params$dpi,
  # selector = ".container-fluid",
...
include_graphics(paste0("webshot/", c("99-ex04", "99-ex05"), ".png"), dpi = params$dpi)
```
</div>

<div class="notes">App [`"materials/99-ex04"`](https://github.com/mcanouil/rshiny/tree/master/materials/99-ex04/app.R)</div>
<div class="notes">App [`"materials/99-ex05"`](https://github.com/mcanouil/rshiny/tree/master/materials/99-ex05/app.R)</div>


## Mise en pratique

* Reproduire l'interface suivante.
...
```{r, code = readLines("materials/99-ex04/app.R", encoding = "UTF-8")[c(5:20)]}
```
...
```{r, code = readLines("materials/99-ex05/app.R", encoding = "UTF-8")[c(5:15)]}
```
...
<div class="notes">
App [`"materials/22-app"`](https://github.com/mcanouil/rshiny/tree/master/materials/22-app/app.R)
...
<div class="notes">
App [`"materials/23-app"`](https://github.com/mcanouil/rshiny/tree/master/materials/23-app/app.R)
...
<div class="notes">
App [`"materials/24-app"`](https://github.com/mcanouil/rshiny/tree/master/materials/24-app/app.R)
...
<div class="notes">
App [`"materials/25-app"`](https://github.com/mcanouil/rshiny/tree/master/materials/25-app/app.R)
...
<div class="notes">
App [`"materials/26-app"`](https://github.com/mcanouil/rshiny/tree/master/materials/26-app/app.R)
...
<div class="notes">App [`"materials/27-app"`](https://github.com/mcanouil/rshiny/tree/master/materials/27-app/app.R)</div>
...
```{r, code = readLines("materials/27-app/app.R", encoding = "UTF-8")[30:54]}
```
...
```{r, code = readLines("materials/28-app/app.R", encoding = "UTF-8")[30:58]}
```

<div class="notes">
App [`"materials/28-app"`](https://github.com/mcanouil/rshiny/tree/master/materials/28-app/app.R)
...
<div class="notes">App [`"materials/30-app"`](https://github.com/mcanouil/rshiny/tree/master/materials/30-app/app.R)</div>
...
<div class="notes">App [`"materials/31-app"`](https://github.com/mcanouil/rshiny/tree/master/materials/31-app/app.R)</div>
...
```{r, code = readLines("materials/32-app/app.R", encoding = "UTF-8")[3:6]}
```

<div class="notes">App [`"materials/32-app"`](https://github.com/mcanouil/rshiny/tree/master/materials/32-app/app.R)</div>


## Contrôle & Validation

```{r, code = readLines("materials/32-app/app.R", encoding = "UTF-8")[8:15]}
```
...
```{r, code = readLines("materials/33-app/app.R", encoding = "UTF-8")[8:18]}
```
...
```{r, code = readLines("materials/34-app/app.R", encoding = "UTF-8")[7:19]}
```
...
<div class="notes">App [`"materials/34-app"`](https://github.com/mcanouil/rshiny/tree/master/materials/34-app/app.R)</div>
...
```{r, code = readLines("materials/35-app/app.R", encoding = "UTF-8")[7:19]}
```
...
<div class="notes">App [`"materials/35-app"`](https://github.com/mcanouil/rshiny/tree/master/materials/35-app/app.R)</div>
...
```{r, code = readLines("materials/36-app/app.R", encoding = "UTF-8")[c(3:20)]}
```

<div class="notes">
App [`"materials/36-app"`](https://github.com/mcanouil/rshiny/tree/master/materials/36-app/app.R)
...
```{r, code = readLines("materials/37-app/app.R", encoding = "UTF-8")[c(3:8, 10:29)]}
```

<div class="notes">
App [`"materials/37-app"`](https://github.com/mcanouil/rshiny/tree/master/materials/37-app/app.R)
...
```{r, code = readLines("materials/38-app/app.R", encoding = "UTF-8")[c(3:8, 10:29)]}
```

<div class="notes">
App [`"materials/38-app"`](https://github.com/mcanouil/rshiny/tree/master/materials/38-app/app.R)
...
## Mettre à jours des `input` {.smaller}

```{r, code = readLines("materials/39-app/app.R", encoding = "UTF-8")[c(3:8, 10:16)]}
```
...
```{r, code = readLines("materials/40-app/app.R", encoding = "UTF-8")[c(3:8, 10:15)]}
```
...
* Générer l'application suivante.
...
<div class="notes">
* App [`"materials/41-app"`](https://github.com/mcanouil/rshiny/tree/master/materials/41-app/app.R)
* App [`"materials/42-app"`](https://github.com/mcanouil/rshiny/tree/master/materials/42-app/app.R)
* App [`"materials/43-app"`](https://github.com/mcanouil/rshiny/tree/master/materials/43-app/app.R)
</div> 
...
<div class="centered vcenter">
```{r, echo = FALSE, eval = TRUE, out.width = "49%", out.extra = 'class="shadow" style="display: inline;"'}
include_graphics(paste0("webshot/", 41:43, ".png"), dpi = params$dpi)
```
</div>
...
code_ellipsis <- c(
  readLines("materials/41-app/app.R", encoding = "UTF-8")[c(1:2, 4:9)],
  "...",
  readLines("materials/41-app/app.R", encoding = "UTF-8")[c(30:32, 34:44, 46)]
)
```
...
```{r, code = readLines("materials/42-app/app.R", encoding = "UTF-8")[c(4:27)]}
```
...
```{r, code = readLines("materials/42-app/app.R", encoding = "UTF-8")[c(1:2, 29:38, 40:50, 52)]}
```
...
```{r, code = readLines("materials/43-app/app.R", encoding = "UTF-8")[c(5:28)]}
```
...
```{r, code = readLines("materials/43-app/app.R", encoding = "UTF-8")[c(30:40)]}
```
...
```{r, code = readLines("materials/43-app/app.R", encoding = "UTF-8")[c(1:4, 42:54)]}
```
...
* `rmarkdown::html_document`  
    \(\Rightarrow\) App [`"materials/44-app"`](https://github.com/mcanouil/rshiny/tree/master/materials/44-app/app.R)

* `rmarkdown::ioslides_presentation`  
    \(\Rightarrow\) App [`"materials/45-app"`](https://github.com/mcanouil/rshiny/tree/master/materials/45-app/app.R)

* `flexdashboard::flex_dashboard`  
    \(\Rightarrow\) App [`"materials/46-app"`](https://github.com/mcanouil/rshiny/tree/master/materials/46-app/app.R)
