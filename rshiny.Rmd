...
# Diapositives et matériel | <i class="fab fa-github" style="font-size: 250px;"></i> {.flexbox .vcenter}

* [mcanouil.github.io/rshiny](https://mcanouil.github.io/rshiny/)

* [github.com/mcanouil/rshiny](github.com/mcanouil/rshiny)
...
* Essayez les différents `input` en jouant sur les arguments (*p. ex.*, `renderDataTable()`).
...
```{r, code = readLines("materials/13-app/app.R", encoding = "UTF-8")[c(3:7, 9:16)]}
```
...
```{r, code = readLines("materials/34-app/app.R", encoding = "UTF-8")[30:58]}
```
...
```{r, code = readLines("materials/37-app/app.R", encoding = "UTF-8")[-c(16, 18, 21, 23)]}
```
...
```{r, code = readLines("materials/37-app/app.R", encoding = "UTF-8")[-c(11, 13, 21, 23)]}
```
...
```{r, code = readLines("materials/37-app/app.R", encoding = "UTF-8")[-c(11, 13, 16, 18)]}
```
...
```{r, code = readLines("materials/43-app/app.R", encoding = "UTF-8")[43:60]}
```
...
## Mise en pratique : Essai 1 {.smaller}
...
## Mise en pratique : Essai 2 {.smaller}
...
## Mise en pratique : Essai 3 {.smaller}
...
* `rmarkdown::html_document`  
    \(\Rightarrow\) App [`"materials/52-app"`](https://github.com/mcanouil/rshiny/tree/master/materials/52-app/app.R)
