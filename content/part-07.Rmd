...
.pull-left[
.code60[
```{r, code = readLines("content/scripts/32-app/app.R", encoding = "UTF-8")[6:28]}
```
]
]
.pull-right[
...
.code60[
```{r, code = readLines("content/scripts/32-app/app.R", encoding = "UTF-8")[30:54]}
```
]
]
...
.code60[
```{r, code = readLines("content/scripts/33-app/app.R", encoding = "UTF-8")[30:51]}
```
]
]
...
.panel[.panel-name[Interface]
.code60[
```{r, code = readLines("content/scripts/36-app/app.R", encoding = "UTF-8")[6:29]}
```
]
]
...
.code60[
```{r, code = readLines("content/scripts/36-app/app.R", encoding = "UTF-8")[31:55]}
```
]
]
...
```{r, code = readLines("content/scripts/37-app/app.R", encoding = "UTF-8")[4:27]}
```
...
```{r, code = readLines("content/scripts/37-app/app.R", encoding = "UTF-8")[29:42]}
```
...
.center[
<img src = "content/media/37.png" width = "62%" />
]
