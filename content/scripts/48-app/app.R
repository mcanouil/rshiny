...
server <- function(input, output, session) {
  output$iris <- renderTable({
    dplyr::filter(iris,
      dplyr::between(Sepal.Length, input$Sepal.Length[1], input$Sepal.Length[2]),
      dplyr::between(Sepal.Width, input$Sepal.Width[1], input$Sepal.Width[2]),
      dplyr::between(Petal.Length, input$Petal.Length[1], input$Petal.Length[2]),
      dplyr::between(Petal.Width, input$Petal.Width[1], input$Petal.Width[2]),
