...
library(remotes)
if (params[["webshot"]]) library(webshot)
library(fs)
library(tidyverse)
library(knitr)
library(rmarkdown)
...
```{r, echo = FALSE, eval = params$webshot, include = FALSE}
app_name <- "34"
appshot(
  app = paste0("materials/", app_name, "-app/app.R"), 
  delay = 2,
...
* ["Mastering Shiny" (en cours d'écriture)](https://mastering-shiny.org/)
