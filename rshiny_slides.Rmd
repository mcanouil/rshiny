...
# <i class="glow">Shiny</i> | L'affichage {.flexbox .vcenter}


## La mise en page "sidebar"

```{r, echo = FALSE, eval = TRUE, fig.align = "left", out.extra = 'class="shadow" style="margin: auto;"', out.width = "100%"}
knitr::include_graphics(paste0("images/sidebar.png"), dpi = dpi)
```


## La mise en page "sidebar" en code

```{r, code = readLines("materials/16-app/app.R", encoding = "UTF-8")[-c(2, 20, 24)]}
```
...
```{r, echo = FALSE, eval = TRUE, fig.align = "left", out.extra = 'class="shadow" style="margin: auto;"', out.width = "100%"}
knitr::include_graphics(paste0("images/multirow.png"), dpi = dpi)
```
...
```{r, code = readLines("materials/17-app/app.R", encoding = "UTF-8")[c(24:29)]}
```
...
```{r, code = readLines("materials/19-app/app.R", encoding = "UTF-8")[c(4:21)]}
```


## La mise en page "dashboard" en code

```{r, code = readLines("materials/19-app/app.R", encoding = "UTF-8")[c(23:31)]}
```
...
# <i class="glow">Shiny</i> | LLa face caché `server` {.flexbox .vcenter}
