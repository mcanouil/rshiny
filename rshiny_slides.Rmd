...
<img src="images/shiny.png" height="250" class="auto-fadein"></img> 
...
Pour ajouter des entrées (`*Input()`).

```{r, code = readLines("materials/00-app/app.R", encoding = "UTF-8")[3]}
```

```{r, code = readLines("materials/01-app/app.R", encoding = "UTF-8")[c(4, 7, 10, 13)]}
```


## L'interface `ui`

Pour ajouter des contrôles et affichages à l'interface.

```{r, code = readLines("materials/01-app/app.R", encoding = "UTF-8")[c(3:5, 7, 10, 12:14)]}
```
...
```{r, code = readLines("materials/01-app/app.R", encoding = "UTF-8")[c(4, 6:8, 10, 13)]}
```
...
```{r, code = readLines("materials/01-app/app.R", encoding = "UTF-8")[c(4, 7, 9:11, 13)]}
```
