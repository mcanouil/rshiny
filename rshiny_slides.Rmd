...
<div class="columns-2">
<img src="images/rstudio_setup.png" width="350" class="shadow"></img>
</br>
<img src="images/rwindows_setup.png" width="350" class="shadow"></img>
</div>

# Qu'est-ce que <i class="glow">Shiny</i> ? | <img src="images/shiny.png" height="250"></img> {.flexbox .vcenter}
...
webshot::appshot(
  ...
  file = "images/00-app.png", 
)
# knitr::include_graphics("images/00-app.png", dpi = dpi)
```

![](images/00-app.png){.shadow}
<div class="notes">
* URL par défaut (hôte)
...
dpi <- 120
webshot::appshot(
  app = "materials/01-app/app.R", 
  delay = 1,
  vwidth = 6.3 * dpi,
  vheight = 4.7 * dpi / 2,
  # selector = ".container-fluid",
  envvars = c(display.mode = "normal"),
  file = "images/01-app.png", 
)
# knitr::include_graphics("images/01-app.png", dpi = dpi)
```

![](images/01-app.png){.shadow}
...
* Partie gauche : objet (`output`) renvoyé vers l'interface (`ui`) avec un identifiant unique (`id`).

* Partie droite : fonction spécifique pour générer la sortie qui pourra être affiché dans l'interface (`ui`).
...
* `textOutput()`, la fonction gérant l'affichage des éléments construit par le serveur (`server`).
...
dpi <- 120
webshot::appshot(
  app = "materials/02-app/app.R", 
  delay = 1,
  vwidth = 6.3 * dpi,
  vheight = 4.7 * dpi / 2,
  # selector = ".container-fluid",
  envvars = c(display.mode = "normal"),
  file = "images/02-app.png", 
)
# knitr::include_graphics("images/01-app.png", dpi = dpi)
```

![](images/02-app.png){.shadow}
